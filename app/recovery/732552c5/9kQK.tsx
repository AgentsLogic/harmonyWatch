...
export default function LandingPage() {
  ...
  const { setIsSignupModalOpen, setSignupModalInitialStep, setSignupModalInitialEmail, setIsLoginModalOpen, isSignupModalOpen, isLoginModalOpen } = useModal();
  ...
  useEffect(() => {
    if (isMobile) {
      document.body.classList.add('landing-page-mobile');
      ...
      document.body.classList.remove('landing-page-mobile');
  ...
  return (
    <div 
      className="min-h-screen bg-black text-white bg-pattern" 
      style={{ 
        paddingBottom: isMobile && !isLoading ? '140px' : '0',
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(/images/landing-pg1.jpg)',
        ...
        {/* Background with blurred content cards (desktop only) */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 to-black/80 hidden sm:block">
        ...
        <div className={`relative z-10 text-center max-w-4xl mx-auto fade-in ${isVisible ? 'visible' : ''}`}>
          <h1 className="hero-title text-5xl md:text-6xl font-serif font-bold mb-6 leading-tight hidden sm:block">
            Orthodox Christian Films, Series, and Podcasts
          </h1>
          
          <p className="hero-subtitle text-xl md:text-2xl mb-8 text-gray-300 hidden sm:block">
      ...
      <footer className="py-8 px-6 bg-black border-t border-gray-800">
       ...
       {mounted && isMobile && !isLoading && createPortal(
         ...
         >
           ...
           <div 
             className="absolute bottom-0 left-0 right-0 px-6 py-4 pointer-events-auto"
           >
