...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white bg-pattern" style={{ paddingBottom: isMobile && !isLoading && !needsToFinishSignup ? '180px' : '0' }}>
      {/* Header */}
      ...
      {/* Sticky Sign Up and Sign In Buttons - Mobile Only */}
      {mounted && isMobile && !isLoading && !needsToFinishSignup && typeof document !== 'undefined' && document.body && createPortal(
        <div 
          className="fixed left-0 right-0 bottom-0 w-full px-6 py-4 z-[9999] sm:hidden bg-black/95 backdrop-blur-sm border-t border-gray-800"
