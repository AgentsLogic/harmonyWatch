...
export default function LandingPage() {
  ...
  // Check if user is authenticated but doesn't have a plan
  // Show "Finish signup" button instead of email form
  const needsToFinishSignup = user && !hasPlan;
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6">
        ...
        <div className={`relative z-10 text-center max-w-4xl mx-auto fade-in ${isVisible ? 'visible' : ''}`}>
          ...
          {!isLoading && needsToFinishSignup ? (
            ...
            // Mobile: Show Sign Up and Sign In buttons
            <div className="max-w-md mx-auto space-y-4">
              <button
                ...
                className="btn-primary bg-red-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-red-700 w-full cursor-pointer"
              >
                Sign Up
              </button>
              <button
                ...
                className="btn-primary bg-gray-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-gray-700 w-full cursor-pointer"
              >
                Sign In
              </button>
            </div>
