...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white bg-pattern" style={{ paddingBottom: isMobile && !isLoading && !needsToFinishSignup ? '180px' : '0' }}>
      ...
      {/* Sticky Sign Up and Sign In Buttons - Mobile Only - Rendered via Portal */}
      {mounted && isMobile && !isLoading && !needsToFinishSignup && typeof document !== 'undefined' && createPortal(
        <div 
          className="fixed inset-x-0 bottom-0 px-6 py-4 z-[9999] sm:hidden bg-black/95 backdrop-blur-sm border-t border-gray-800"
