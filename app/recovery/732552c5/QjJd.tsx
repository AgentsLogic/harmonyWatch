  ...
  return (
    <div className="min-h-screen bg-black text-white bg-pattern">
      ...
      {isMobile && !isLoading && !needsToFinishSignup && (
        <div className="absolute inset-x-0 bottom-0 px-6 py-4 z-50 sm:hidden bg-black/95 backdrop-blur-sm border-t border-gray-800" style={{ position: 'sticky', bottom: 0 }}>
