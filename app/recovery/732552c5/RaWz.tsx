  ...
  return (
    <div className="min-h-screen bg-black text-white bg-pattern" style={{ paddingBottom: isMobile && !isLoading && !needsToFinishSignup ? '140px' : '0' }}>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-black/80 sm:hidden" />
      ...
      <footer className="py-8 px-6 bg-black border-t border-gray-800">
       ...
       {mounted && isMobile && !isLoading && !needsToFinishSignup && createPortal(
         <div 
           className="sm:hidden fixed bottom-0 left-0 right-0 z-50 px-6 py-4"
           style={{ 
             position: 'fixed', 
             bottom: 0, 
             left: 0, 
         ...
         >
           <div className="max-w-md mx-auto space-y-4">
             <h1 className="text-left text-white mb-5 font-semibold" style={{ fontSize: '21px' }}>
