  ...
  return (
    <div className="min-h-screen bg-black text-white bg-pattern" style={{ paddingBottom: isMobile && !isLoading && !needsToFinishSignup ? '140px' : '0' }}>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 to-black/80 sm:bg-gradient-to-b sm:from-black/50 sm:to-black/80">
          <div className="absolute inset-0 opacity-20 sm:opacity-20">
            <div className="grid grid-cols-4 gap-4 p-8 blur-sm hidden sm:grid">
