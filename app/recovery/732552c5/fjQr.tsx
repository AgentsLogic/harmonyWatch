...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white bg-pattern" style={{ paddingBottom: isMobile && !isLoading && !needsToFinishSignup ? '180px' : '0' }}>
      ...
      {isMobile && !isLoading && !needsToFinishSignup && (
        <>
          {typeof document !== 'undefined' && document.getElementById('main-scroll-container') && (
            <div 
              className="fixed inset-x-0 bottom-0 px-6 py-4 z-[100] sm:hidden bg-black/95 backdrop-blur-sm border-t border-gray-800"
              style={{ 
                position: 'fixed',
                left: 0,
                right: 0,
