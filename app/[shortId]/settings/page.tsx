...
export default function ShortIdSettingsPage() {
  const params = useParams();
  const shortId = params.shortId as string;
  const router = useRouter();
  const { user, isLoading: userLoading } = useUser();
  const { setIsSettingsModalOpen, setVideoContentId, setIsVideoModalOpen, isVideoModalOpen, videoContentId, setSelectedItem, setIsModalOpen } = useModal();
